        ...
        <div class="col-md-6 col-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form class="form form-vertical" action="{{route('dashboard.users.store')}}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('post') }}
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-vertical" class="form-control" value="{{ old('first_name') }}" name="first_name" placeholder="First Name">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="last-name-vertical">@lang('site.last_name')</label>
                                            <input type="text" id="last-name-vertical" class="form-control" value="{{ old('last_name') }}" name="last_name" placeholder="Last Name">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="email-id-vertical">@lang('site.email')</label>
                                            <input type="email" id="email-id-vertical" class="form-control" name="email" value="{{ old('email') }}" placeholder="Email">
                                        </div>
                                    </div>
                                                ...
                                                <table class="table table-borderless">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                                ...
                                                                @foreach ($maps as $map)
                                                                <td>
                                                                    <input class="lists" type="checkbox" value="{{ $map . '_' . $model }}" name="permissions[]">
                                                                </td>
                                                                @endforeach
